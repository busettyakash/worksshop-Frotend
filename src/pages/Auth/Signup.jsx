  ...
  return (
    <AuthLayout rightPanel={rightPanel}>
      ...
      <button type="button" className="ws-auth-google-btn">
        <svg className="ws-auth-google-icon" viewBox="0 0 24 24">
      ...
      {apiError && <p className="ws-auth-error-text" style={{ textAlign: 'center' }}>{apiError}</p>}
      ...
      <form className="ws-auth-form" onSubmit={handleSubmit} noValidate>
        ...
        <Input name="gstin" placeholder="GSTIN number (e.g. 27ABCDE1234F1Z5)" icon={FileText}
